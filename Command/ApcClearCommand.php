...
class ApcClearCommand extends ContainerAwareCommand
{
    ...
    {
        $this->setDescription('Clear APC cache')
            ->setName('symbio:apc:clear')
            ->addOption('base-url', null, InputOption::VALUE_REQUIRED, 'URL for clear APC cache');
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $templateFile = __DIR__.'/../Resources/apc_clear.template.tpl';
